package com.poly.users.config;

import com.poly.users.config.security.filter.StatelessAuthenticationFilter;
import com.poly.users.config.security.filter.StatelessLoginFilter;
import com.poly.users.config.security.service.AppUserDetailsService;
import com.poly.users.config.security.service.TokenAuthService;
...
//        http.cors().disable();
        http.cors().configurationSource(request -> {
            ...
            cors.setAllowedOrigins(Arrays.asList("http://localhost:63342", "http://127.0.0.1:5500", "http://127.0.0.1:5501", "http://localhost:8080"));
